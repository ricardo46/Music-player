  ...
  return (
    <>
      {router.pathname == USER_PAGE_PATH &&
        ...
        songIndexInSearchList == numberOfOtherUserSongsInSearchResults && (
          <SearchTitle>Your songs:</SearchTitle>
        )}
    </>
  );
};

export default CurrentUserSearchTitle;
